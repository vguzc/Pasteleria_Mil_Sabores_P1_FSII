  ...
  cuerpo.innerHTML = productos.map(p => `
    <tr>
      ...
      <td class="acciones-fila">
        <button class="boton-icono" title="Editar" onclick="abrirModalProducto('${p.codigo}')">✏️</button>
        <button class="boton-icono eliminar" title="Eliminar" onclick="eliminarProducto('${p.codigo}')">🗑️</button>
      </td>
    </tr>
  `).join('');
}
...
function renderizarTablaUsuarios() {
  ...
  cuerpo.innerHTML = usuarios.map((u, indice) => `
    <tr>
      ...
      <td class="acciones-fila">
        <button class="boton-icono" title="Editar" onclick="abrirModalUsuario(${indice})">✏️</button>
        <button class="boton-icono eliminar" title="Eliminar" onclick="eliminarUsuario(${indice})">🗑️</button>
      </td>
    </tr>
  `).join('');
}
